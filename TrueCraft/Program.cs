...
public class Program
{
    ...
    public static void Main(string[] args)
    {
        try
        {
            ...
            {
                var seed = MathHelper.Random.Next();
            ...
            Server.Start(
                new IPEndPoint(
                    IPAddress.Parse(ServerConfiguration.ServerAddress),
    ...
    private static void HandleCancelKeyPress(object? sender, ConsoleCancelEventArgs e) => Server!.Stop();
}