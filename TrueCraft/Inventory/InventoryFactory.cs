...
{
    public IWindow<IServerSlot> NewInventoryWindow(
    ...
    public ICraftingBenchWindow<IServerSlot> NewCraftingBenchWindow(
        IItemRepository itemRepository,
        ICraftingRepository craftingRepository,
        ISlotFactory<IServerSlot> slotFactory,
        sbyte windowID,
    ...
    public IChestWindow<IServerSlot> NewChestWindow(
        IItemRepository itemRepository,
        ISlotFactory<IServerSlot> slotFactory,
        sbyte windowID,
        ISlots<IServerSlot> mainInventory,
    ...
    public IFurnaceWindow<IServerSlot> NewFurnaceWindow(
