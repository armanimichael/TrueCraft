...
public struct ItemStack : ICloneable, IEquatable<ItemStack>, IEquatable<NbtTag>
{
    ...
    public override int GetHashCode()
    {
        unchecked
        {
            ...
            hashCode = (hashCode * 397) ^ (Nbt != null
                ? Nbt.GetHashCode()
                : 0);
    ...
    public ItemStack(XmlNode stack)
    {
        ...
        var countNode = idNode.NextSibling;
        ...
        var metadataNode = countNode.NextSibling;
    ...
    /// </summary>
    /// <returns></returns>
    public object Clone() => new ItemStack(ID, Count, Metadata, Nbt);

    /// <summary>
    /// Gets an empty item stack.
    /// </summary>
    [NbtIgnore]
    public static ItemStack EmptyStack => new(-1);
    ...
    public ItemStack GetReducedStack(int n)
    {
        ...
        if (n > Count)
        {
            throw new ArgumentOutOfRangeException(
                $"This ItemStack only contains {Count} items.  It cannot be reduced by {n}."
            );
        }
#endif
        if (Count - n > 0)
    ...
    /// <param name="other">The other item stack.</param>
    /// <returns></returns>
    public bool Equals(ItemStack other) => _Id == other._Id && _Count == other._Count && _Metadata == other._Metadata && Index == other.Index &&
    ...
    public bool Equals(NbtTag? nbt)
    {
        ...
        var metadata = other.Get<NbtShort>("Damage");
        ...
        var count = other.Get<NbtByte>("Count");
        ...
        var slot = other.Get<NbtByte>("Slot");
    ...
    public static bool operator ==(ItemStack l, NbtTag? r) => l.Equals(r);

    public static bool operator !=(ItemStack l, NbtTag? r) => !(l == r);

    public static bool operator ==(NbtTag? l, ItemStack r) => r == l;
