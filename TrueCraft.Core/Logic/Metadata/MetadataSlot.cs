...
public class MetadataSlot : MetadataEntry
{
    ...
    public static implicit operator MetadataSlot(ItemStack value) => new(value);
    ...
    public override void FromStream(IMinecraftStream stream) => Value = ItemStack.FromStream(stream);
