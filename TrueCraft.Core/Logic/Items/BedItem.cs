...
public class BedItem : ItemProvider
{
    ...
    )
    {
        ...
        if (!BedBlock.ValidBedPosition(
                new BlockDescriptor { Coordinates = head },
                dimension.BlockRepository,
                user.Dimension!,
                false,
                true
            ) ||
            !BedBlock.ValidBedPosition(
                new BlockDescriptor { Coordinates = foot },
                dimension.BlockRepository,
                user.Dimension!,
                false,
                true
