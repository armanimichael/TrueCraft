...
public struct BoundingCylinder : IEquatable<BoundingCylinder>
{
    ...
    public bool Intersects(Vector3 q) => DistancePointLine(q, Min, Max) < Radius;
    ...
    public static double DistancePointLine(Vector3 point, Vector3 lineStart, Vector3 lineEnd) => (ProjectPointLine(point, lineStart, lineEnd) - point).Distance;
    ...
    public bool Equals(BoundingCylinder other) => other.Max == Max
                                                  && other.Min == Min
                                                  && other.Radius == Radius;
}