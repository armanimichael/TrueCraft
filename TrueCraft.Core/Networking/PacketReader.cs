...
public class PacketReader : IPacketReader
{
    ...
    public void RegisterCorePackets()
    {
        ...
        RegisterPacketType<EntityEquipmentPacket>(
            serverbound: false,
            clientbound: true
        ); // 0x05 // NOTE: serverbound not confirmed
    ...
    public void RegisterPacketType<T>(bool clientbound = true, bool serverbound = true)
        where T : IPacket
    {
