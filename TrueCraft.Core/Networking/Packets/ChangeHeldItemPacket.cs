...
public struct ChangeHeldItemPacket : IPacket
{
    ...
    public short Slot => _slot;

    public void ReadPacket(IMinecraftStream stream) => _slot = stream.ReadInt16();

    public void WritePacket(IMinecraftStream stream) => stream.WriteInt16(_slot);
}