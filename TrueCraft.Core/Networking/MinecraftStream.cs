...
public class MinecraftStream : Stream, IMinecraftStream
{
    ...
    public ushort ReadUInt16() => (ushort) (
        (ReadUInt8() << 8) |
        ReadUInt8());

    public void WriteUInt16(ushort value) => Write(
        new[]
        {
            (byte) ((value & 0xFF00) >> 8),
            (byte) (value & 0xFF)
    ...
    public void WriteUInt32(uint value) => Write(
        new[]
        {
    ...
    public ulong ReadUInt64() => unchecked(
        ((ulong) ReadUInt8() << 56) |
        ((ulong) ReadUInt8() << 48) |
        ((ulong) ReadUInt8() << 40) |
        ((ulong) ReadUInt8() << 32) |
    ...
    public void WriteUInt64(ulong value) => Write(
        new[]
        {
    ...
    public void WriteUInt8Array(byte[] value, int offset, int count) => Write(value, offset, count);
    ...
    public void WriteBoolean(bool value) => WriteUInt8(
        value
            ? (byte) 1
            : (byte) 0
    );
