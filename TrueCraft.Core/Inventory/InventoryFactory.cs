...
/// 
/// </summary>
public class InventoryFactory<T> : IInventoryFactory<T>
    where T : ISlot
{
    ...
    public static void RegisterInventoryFactory(IInventoryFactory<T> factory) => _impl = factory;

    public IWindow<T> NewInventoryWindow(
        IItemRepository itemRepository,
        ICraftingRepository craftingRepository,
        ISlotFactory<T> slotFactory,
        ISlots<T> mainInventory,
        ISlots<T> hotBar
    ) => _impl.NewInventoryWindow(
        itemRepository,
        craftingRepository,
        slotFactory,
        mainInventory,
    ...
    public ICraftingBenchWindow<T> NewCraftingBenchWindow(
        IItemRepository itemRepository,
        ICraftingRepository craftingRepository,
        ISlotFactory<T> slotFactory,
        sbyte windowID,
    ...
    public IChestWindow<T> NewChestWindow(
        IItemRepository itemRepository,
        ISlotFactory<T> slotFactory,
        sbyte windowID,
        ISlots<T> mainInventory,
    ...
    public IFurnaceWindow<T> NewFurnaceWindow(
