...
public class PanDimensionalVoxelCoordinates : IEquatable<PanDimensionalVoxelCoordinates>
{
    ...
    public DimensionID DimensionID => _dimensionID;
    public int X => _x;
    public int Y => _y;
    public int Z => _z;
    ...
    public override bool Equals(object? obj) => Equals(obj as PanDimensionalVoxelCoordinates);

    public override int GetHashCode()
    {
        unchecked
        {
            var rv = (int) _dimensionID;
    ...
    public static bool operator !=(PanDimensionalVoxelCoordinates? l, PanDimensionalVoxelCoordinates? r) => !(l == r);
