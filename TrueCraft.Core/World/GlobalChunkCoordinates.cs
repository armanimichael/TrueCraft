...
public class GlobalChunkCoordinates : IEquatable<GlobalChunkCoordinates>
{
    ...
    public static bool operator !=(GlobalChunkCoordinates? a, GlobalChunkCoordinates? b) => !(a == b);
    ...
    /// <returns></returns>
    public override bool Equals(object? obj) => Equals(obj as GlobalChunkCoordinates);
    ...
    {
        var x = (int) Math.Floor(value.X);
        var y = (int) Math.Floor(value.Y);
        var z = (int) Math.Floor(value.Z);
        int chunkX, chunkZ;
    ...
    public static readonly GlobalChunkCoordinates Zero = new(0, 0);
