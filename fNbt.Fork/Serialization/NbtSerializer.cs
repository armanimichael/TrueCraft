...
public class NbtSerializer
{
    ...
    public NbtTag Serialize(object value, bool skipInterfaceCheck = false) => Serialize(value, "", skipInterfaceCheck);
    ...
    public NbtTag Serialize(object value, string tagName, bool skipInterfaceCheck = false)
    {
        ...
        else
        {
            ...
            var properties = Type.GetProperties()
                                 .Where(
                                     p => Attribute.GetCustomAttributes(
                                                       p,
    ...
    public object Deserialize(NbtTag value, bool skipInterfaceCheck = false)
    {
        ...
        else if (value is NbtCompound)
        {
            ...
            var properties = Type.GetProperties()
                                 .Where(
                                     p =>
                                         Attribute.GetCustomAttributes(p, typeof(NbtIgnoreAttribute)).Length == 0
                                 );
