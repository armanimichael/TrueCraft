...
internal sealed class NbtBinaryWriter(Stream input, bool bigEndian) : BinaryWriter(input)
{
    public void Write(NbtTagType value) => Write((byte) value);
    ...
    public static short Swap(short v) => (short) (((v >> 8) & 0x00FF) |
                                                  ((v << 8) & 0xFF00));
    ...
    public static long Swap(long v) => ((Swap((int) v) & uint.MaxValue) << 32) |
