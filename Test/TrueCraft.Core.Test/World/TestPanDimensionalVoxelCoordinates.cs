...
public class TestPanDimensionalVoxelCoordinates
{
    ...
    {
        var actual = new PanDimensionalVoxelCoordinates(dimensionID, x, y, z);
    ...
    {
        var a = new PanDimensionalVoxelCoordinates(id1, x1, y1, z1);
        var b = new PanDimensionalVoxelCoordinates(id2, x2, y2, z2);
    ...
    {
        var a = new PanDimensionalVoxelCoordinates(DimensionID.Overworld, 2, 3, 5);
