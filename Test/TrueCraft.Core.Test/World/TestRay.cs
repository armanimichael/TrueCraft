...
public class TestRay
{
    ...
    public void Ctor()
    {
        ...
        var direction = new Vector3(0.2, 0.3, 0.5);

        var actual = new Ray(pos, direction);
    ...
    public void Intersects(
        ...
        BlockFace expectedBlockFace,
        Ray ray,
        BoundingBox box
    )
    {
        var actualBlockFace = BlockFace.PositiveY;
        var actualDistance = double.MinValue;

        var actualIntersects = ray.Intersects(box, ref actualDistance, ref actualBlockFace);
        ...
        if (expectedToIntersect)
        {
            ...
            Assert.True(
                Math.Abs(expectedDistance - actualDistance) < GameConstants.Epsilon,
                "Expected Distance: {0}\nActual Distance: {1}",
                expectedDistance,
                actualDistance
            );
