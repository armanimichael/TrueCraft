...
public class TestLocalVoxelCoordinates
{
    ...
    {
        var a = new LocalVoxelCoordinates(x, y, z);
    ...
    {
        var a = new LocalVoxelCoordinates(2, 3, 5);
        var b = new LocalVoxelCoordinates(3, 3, 5);
        var c = new LocalVoxelCoordinates(2, 4, 5);
        var d = new LocalVoxelCoordinates(2, 3, 6);
        var e = new LocalVoxelCoordinates(2, 3, 5);
    ...
    {
        var a = new LocalVoxelCoordinates(2, 3, 5);
        var b = new LocalVoxelCoordinates(a.X + 1, a.Y, a.Z);
        var c = new LocalVoxelCoordinates(a.X, a.Y + 1, a.Z);
        var d = new LocalVoxelCoordinates(a.X, a.Y, a.Z + 1);
        var e = new LocalVoxelCoordinates(a.X, a.Y, a.Z);
    ...
    {
        var a = new LocalVoxelCoordinates(x1, y1, z1);
        var b = new Vector3i(x2, y2, z2);
        var expected = new LocalVoxelCoordinates(x1 + x2, y1 + y2, z1 + z2);
    ...
    {
        // Too far north
        var a = new LocalVoxelCoordinates(5, 27, 0);
    ...
    {
        var global = new GlobalVoxelCoordinates(globalX, globalY, globalZ);

        var actual = (LocalVoxelCoordinates) global;
