...
public class TestLocalChunkCoordinates
{
    ...
    {
        var actual = new LocalChunkCoordinates(x, z);
    ...
    {
        var a = new LocalChunkCoordinates(2, 5);
        var b = new LocalChunkCoordinates(3, 7);
        var c = new LocalChunkCoordinates(a.X, a.Z);
        var d = new GlobalChunkCoordinates(a.X, a.Z);
    ...
    {
        var a = new LocalChunkCoordinates(7, 11);
        var b = new LocalChunkCoordinates(5, 3);
    ...
    {
        var a = new LocalChunkCoordinates(2, 3);
        var b = new LocalChunkCoordinates(3, 2);
        var c = new LocalChunkCoordinates(2, 3);
    ...
    {
        var a = new LocalChunkCoordinates(x, z);
    ...
    [TestCase(0, 0, 0, 0)]
    [TestCase(
        WorldConstants.RegionWidth - 1,
        WorldConstants.RegionDepth - 1,
        WorldConstants.RegionWidth - 1,
        WorldConstants.RegionDepth - 1
    )]
    ...
    [TestCase(
        WorldConstants.RegionWidth - 1,
        WorldConstants.RegionDepth - 1,
        (2 * WorldConstants.RegionWidth) - 1,
        (2 * WorldConstants.RegionDepth) - 1
    )]
    ...
    public void Convert_From_GlobalChunkCoordinates(int localX, int localZ, int globalX, int globalZ)
    {
        ...
        var actual = (LocalChunkCoordinates) global;
    ...
    {
        var global = new GlobalVoxelCoordinates(globalX, _random.Next(127), globalZ);
