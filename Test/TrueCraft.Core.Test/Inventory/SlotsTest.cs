...
public class SlotsTest
{
    ...
    public void ctor()
    {
        ...
        var count = 56;
        var slots = new Slots<ISlot>(mock.Object, GetSlots(mock.Object, count));
    ...
    public void TestIndexing()
    {
        ...
        var slotCount = 8;
        var slots = new List<ISlot>(slotCount);
        ...
        var area = new Slots<ISlot>(mock.Object, slots);
        ...
        Assert.Throws<ArgumentOutOfRangeException>(
            () =>
            {
                var x = area[slotCount];
            }
        );

        // Test storage and retrieval
        var area0Stack = new ItemStack(10);
        area[0].Item = area0Stack;

        var area1Stack = new ItemStack(20);
    ...
    )
    {
        ...
        Assert.True(
            expectedID.Length == expectedCount.Length &&
        ...
        Assert.True(
            expectedRemainCount <= addCount,
            $"{nameof(expectedRemainCount)} must be less than or equal to {nameof(addCount)}"
        );
        ...
        // Setup
        var slots = new List<ISlot>(contentID.Length);
        ...
        var actual = new Slots<ISlot>(itemRepository, slots);
        ...
        var add = new ItemStack(addID, addCount);

        // Action
        var remaining = actual.StoreItemStack(add, topUpOnly);
