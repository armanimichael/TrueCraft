...
public class Dimension : IDimensionClient
{
    ...
    /// <inheritdoc />
    public string Name => DimensionInfo.GetName(ID);
    ...
    /// <inheritdoc />
    public void AddChunk(IChunk chunk) => _chunks[chunk.Coordinates] = chunk;
    ...
    /// <inheritdoc />
    public bool IsValidPosition(GlobalVoxelCoordinates position) => position.Y >= 0 && position.Y < WorldConstants.Height;
    ...
    /// <inheritdoc />
    IEnumerator IEnumerable.GetEnumerator() => _chunks.Values.GetEnumerator();

    /// <inheritdoc />
    public IEnumerator<IChunk> GetEnumerator() => _chunks.Values.GetEnumerator();
}