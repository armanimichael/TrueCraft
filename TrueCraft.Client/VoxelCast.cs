...
public static class VoxelCast
{
    ...
    public static Tuple<GlobalVoxelCoordinates, BlockFace>? Cast(
    ...
    )
    {
        ...
        {
            var coords = (GlobalVoxelCoordinates) (new Vector3(x, y, z) + ray.Position).Round();
