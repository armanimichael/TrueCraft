...
{
    private const int _timeToFade = 9 * 1000;
    private const int _timeToExpire = 10 * 1000;
    ...
    public override bool KeyUp(GameTime gameTime, KeyboardKeyEventArgs e) => Editing;
    ...
    public void Draw(GameTime gameTime)
    {
        ...
        for (var i = 0; i < Messages.Count && i < max; i++)
        {
            ...
            if (time > _timeToFade && !Editing)
            {
                var t = _timeToExpire - (time / (double) (_timeToExpire - _timeToFade));
                alpha = (byte) (t * 256);
            }
