...
public class DebugInfoModule : InputModule, IGraphicalModule
{
    ...
    public void Draw(GameTime gameTime)
    {
        ...
        Font.DrawText(
            ...
            yOrigin,
            string.Format(
                ChatFormat.Bold + "Running at {0}{1} FPS",
                GetFPSColor(fps),
                fps
            )
        );
        ...
        Font.DrawText(
            ...
            yOrigin + (yOffset * 1),
            string.Format(
                "Standing at <{0:N2}, {1:N2}, {2:N2}>",
                Game.Client.Position.X,
                Game.Client.Position.Y,
                Game.Client.Position.Z
            )
        );
        ...
        Font.DrawText(
            ...
            xOrigin,
            yOrigin + (yOffset * 2),
            ChatColor.Gray + $"Looking at {Game.HighlightedBlock} ({Enum.GetName(Game.HighlightedBlockFace)})"
        );
        ...
        Font.DrawText(
            ...
            xOrigin,
            yOrigin + (yOffset * 3),
            string.Format(ChatColor.Gray + "{0} pending chunks", Game.ChunkModule?.ChunkModeller.PendingChunks ?? 0)
        );
