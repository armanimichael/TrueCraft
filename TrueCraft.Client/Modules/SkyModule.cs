...
public class SkyModule : IGraphicalModule
{
    ...
    private float CelestialAngle
    {
        get
        {
            var x = (Game.Client.Dimension.TimeOfDay / 24000f) - 0.25f;
    ...
    public Color WorldFogColor
    {
        get
        {
            ...
            return new Color(
                (0.7529412f * y * 0.94f) + 0.06f,
                (0.8470588f * y * 0.94f) + 0.06f,
                (1.0f * y * 0.91f) + 0.09f
            );
        }
    }
    ...
    public Color AtmosphereColor
    {
        get
        {
            ...
            var blend = (float source, float destination) =>
