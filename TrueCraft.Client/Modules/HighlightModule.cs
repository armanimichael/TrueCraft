...
public class HighlightModule : IGraphicalModule
{
    ...
    private Mesh GenerateProgressMesh()
    {
        ...
        var vertices = BlockModeller.CreateUniformCube(
            XVector3.Zero,
            texture,
            VisibleFaces.All,
            0,
    ...
    {
        var direction = XVector3.Transform(
            XVector3.UnitZ,
        ...
        {
            var provider =
                _serviceLocator.BlockRepository.GetBlockProvider(_game.Client.Dimension.GetBlockID(cast.Item1));
    ...
    public void Draw(GameTime gameTime)
    {
        ...
        if (!ReferenceEquals(_game.HighlightedBlock, null))
        {
            ...
            foreach (var pass in _highlightEffect.CurrentTechnique.Passes)
            {
                ...
                _highlightEffect.GraphicsDevice.DrawUserIndexedPrimitives<VertexPositionColor>(
                    ...
                    CubeVerticies,
                    0,
                    CubeVerticies.Length,
                    CubeIndicies,
                    0,
                    CubeIndicies.Length / 2
                );
            }
        }
