...
public class VegetationModeller : FlatQuadModeller
{
    ...
    protected static Vector2 DandelionTextureMap => new(13, 0);
    protected static Vector2 RoseTextureMap => new(12, 0);
    protected static Vector2 TallGrassTextureMap => new(7, 2);
    protected static Vector2 DeadBushTextureMap => new(7, 3);
    protected static Vector2 FernTextureMap => new(8, 3);
    protected static Vector2 OakSaplingTextureMap => new(15, 0);
    protected static Vector2 SpruceSaplingTextureMap => new(15, 3);
    protected static Vector2 BirchSaplingTextureMap => new(15, 4);
