...
public class CraftingTableModeller : BlockModeller
{
    ...
    private static Vector2 TopTexture = new(11, 2);
    private static Vector2 BottomTexture = new(4, 0);
    private static Vector2 SideATexture = new(11, 3);
    private static Vector2 SideBTexture = new(12, 3);
